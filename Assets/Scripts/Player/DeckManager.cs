...
public class DeckManager : MonoBehaviour
{
    ...
    CardsData CardsData
    {
        ...
        {
            CardsData data = new();
            data.magazineSize = loadout.CurrentGun.CurrentStats.magazineSize;
            data.ammoCount = loadout.CurrentGun.GetAmmoInMagazine;
    ...
    public void RefreshUI() => OnAmmoChange?.Invoke(currentDeck, CardsData); 
}
